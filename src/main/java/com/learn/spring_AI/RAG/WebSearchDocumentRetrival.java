...
public class WebSearchDocumentRetrival implements DocumentRetriever {

    private static final Logger logger = LoggerFactory.getLogger(WebSearchDocumentRetrival.class);

    private static final String TAVILY_API_KEY = "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";
    private static final String TAVILY_BASE_URL = "https://api.tavily.com/search";
    private static final int DEFAULT_RESULT_LIMIT = 5;
    private final int resultLimit;
    private final RestClient restClient;

    public WebSearchDocumentRetrival(RestClient.Builder clientBuilder, int resultLimit) {
    ...
    public List<Document> retrieve(Query query) {
        ...
        TavilyResponsePayload response = restClient.post()
                .body(new TavilyRequestPayload(q, "basic", resultLimit))
                .retrieve()
    ...
    public static class Builder {
        ...
        public WebSearchDocumentRetrival build() {
            return new WebSearchDocumentRetrival(clientBuilder, resultLimit);
        }
    }
}